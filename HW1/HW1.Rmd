...
&= argmax_{1 \leq k \leq K}Pr(y = c_k|\bar{x}) \quad \square
\end{aligned}
$$
...
Suppose that we have an existing split of $R_m$ into $R_l$ and $R_r$, with $n$, $n_l$, $n_r$ as well as $\bar{y}_l$ and $\bar{y}_r$ defined as in the above problem. \\
...
$$
\begin{aligned}
Improvement &= S_m - S_{lr} - (S_m - S_{l^*r^*}) \\
