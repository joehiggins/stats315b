...
\item Since the goal of multitask learning is to find the best combination of outputs, a multiple-output model may comprimise accuracy for one output in order to minimize overall loss.
\end{itemize}
